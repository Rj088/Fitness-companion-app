...
export default function AuthPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* App Info */}
      <div className="hidden sm:flex sm:w-1/2 bg-primary/10 p-10 flex-col justify-center">
        <div className="space-y-6">
          <h1 className="text-4xl font-bold">FitTrack - Your Fitness Journey</h1>
          <p className="text-lg">
            Track your workouts, monitor your nutrition, and achieve your fitness goals with our
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>Personalized workout plans</div>
            </div>
            <div className="flex items-center space-x-3">
              <div className="bg-primary/20 p-2 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div>Nutrition tracking and meal planning</div>
            </div>
            <div className="flex items-center space-x-3">
              <div className="bg-primary/20 p-2 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
